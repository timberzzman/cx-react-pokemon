  ...
  if (isLoaded) {
    return (
      <div>
        ...
        <a className="absolute left focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent" href="http://localhost:3000/"><FontAwesomeIcon icon= {faLongArrowAltLeft} size="7x"/></a>
          ...
          <div>
            <button className="absolute right-0 text-black bg-red hover:bg-red-dark text-white font-bold py-2 px-4 rounded">
